...
export const TALKS = [
  ...
  { year: '2024', type: 'Chair',    event: 'Biophysics Annual Scientific Meeting, UAM',                  location: 'Madrid',                            note: '"Physical properties of molecular, nanometric and biological systems"' },
  ...
  { year: '2022', type: 'Talk',     event: 'FENS Forum',                                                 location: 'Paris, France',                     note: '"Inference of hippocampal representations with neural manifolds"' },
  ...
  { year: '2022', type: 'Talk',     event: "Cajal Junior's Meeting",                                     location: 'Madrid',                            note: '"Inference of hippocampal representations with neural manifolds"' },
  ...
  { year: '2019', type: 'Talk',     event: 'Conference of Junior Researchers, Instituto Cajal',          location: 'Madrid',                            note: '"Local field potential data analysis in vivo: deciphering functional astrocyte-neuron networks"' },
];
